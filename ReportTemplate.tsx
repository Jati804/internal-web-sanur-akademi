...
<div style={{ marginBottom: '30px', position: 'relative', zIndex: 10, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
  ...
  <p style={{ fontSize: '9px', fontWeight: '900', color: '#94a3b8', textTransform: 'uppercase', margin: '0 -2px 3px 0' }}>Guru Penilai</p>
  <p style={{ fontSize: '13px', fontWeight: '900', color: '#1e293b', textTransform: 'uppercase', margin: 0, whiteSpace: 'nowrap', letterSpacing: '0.05em' }}>{reportLog.teacherName || '-'}</p>
  </div>
</div>
