...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .page-landscape-inner { width: 100%; height: 100%; border-top: 4px solid #cbd5e1; border-right: 4px solid #cbd5e1; border-bottom: 4px solid #cbd5e1; border-left: 7px solid #cbd5e1; display: flex; flex-direction: row; box-sizing: border-box; }
...
<div class="page-wrapper">
  <div class="page-landscape">
    <div class="page-landscape-inner">
      <div style="width:146px; margin:0 -3px; background:${gradientSidebar}; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:30px 15px; flex-shrink:0;">
