  ...
  <div class="page-portrait">
    ...
    <div style="margin-bottom:30px; display:flex; justify-content:space-between; align-items:flex-end;">
      ...
      <div style="display:flex; flex-direction:column; align-items:flex-end; text-align:right;">
        ...
        <p style="font-size:13px; font-weight:900; color:#1e293b; text-transform:uppercase; letter-spacing:0.05em; margin:0 -0.05em 0 0; white-space:nowrap;">${req.teacherName || '-'}</p>
      </div>
    </div>
      ...
      {showMilestoneFor && (
        ...
        <div data-modal-container className="fixed inset-0 z-[120000] flex items-center justify-center p-6 bg-slate-900/90 backdrop-blur-xl opacity-0" style={{animation: 'modalFadeIn 0.3s ease-out forwards'}}>
           <div className="bg-white w-full max-w-2xl rounded-[4rem] p-12 shadow-2xl relative overflow-hidden space-y-10 opacity-0" style={{animation: 'modalZoomIn 0.3s ease-out 0.1s forwards'}}>
              <button onClick={() => setShowMilestoneFor(null)} className="absolute top-8 right-8 w-9 h-9 bg-slate-100 hover:bg-rose-500 hover:text-white text-slate-500 rounded-full flex items-center justify-center transition-all shadow-sm"><X size={16}/></button>
