         ...
         <div className="space-y-2 text-center md:text-left flex-1">
            ...
            {activeTab === 'STUDENTS' && (
              <p className="text-[10px] font-black text-rose-600 uppercase italic pt-1 flex items-center justify-center md:justify-start gap-2">
                 <Zap size={14} /> Khusus Siswa: Akun siswa hanya boleh ganti Nama selama kelas berjalan dan rapot belum diterbitkan (untuk username dan PIN tetap bisa di ubah walaupun siswa sudah menerima rapot). Disarankan hapus manual akun siswa, jika akun siswa sudah tidak digunakan selama lebih dari 6 bulan, agar sistem tetap ringan!
              </p>
            )}
         </div>
      </div>
