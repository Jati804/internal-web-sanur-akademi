...
useEffect(() => {
  ...
  <>
    ...
    <div className="space-y-12 animate-in pb-40 px-2">
      ...
      {selectedPayout && (
  <div 
    className="fixed top-0 left-0 right-0 bottom-0 z-[100000] bg-slate-900/90 backdrop-blur-xl flex items-center justify-center p-6"
...
>
      ...
      {showImportModal && (
  <div 
    className="fixed top-0 left-0 right-0 bottom-0 z-[100000] bg-slate-900/95 backdrop-blur-xl flex items-center justify-center p-6"
    style={{ animation: 'fadeIn 0.2s ease-out' }}
  >
    <div 
...
>
      ...
      {previewImg && (
  <div 
    className="fixed top-0 left-0 right-0 bottom-0 z-[300000] bg-slate-900/95 flex flex-col items-center justify-center p-6" 
