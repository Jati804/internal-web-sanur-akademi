  ...
  <div className="md:col-span-2 space-y-4 animate-in slide-in-from-top-2 relative">
     ...
     <p className="text-[8px] font-bold text-slate-400 uppercase ml-4 tracking-widest italic">Tiap siswa private punya kotak gaji terpisah ✨</p>
            ...
            <div className="space-y-4">
               ...
               <div className="h-[72px] rounded-[2rem] bg-orange-600 border-2 border-orange-600 shadow-lg flex items-center justify-center gap-2 text-white cursor-default">
                  <span className="font-black text-[11px]">2 JAM</span>
                  <span className="font-black text-[11px]">/ PERTEMUAN</span>
               </div>
            </div>
