  ...
  <div className="md:col-span-2 space-y-4 animate-in slide-in-from-top-2 relative">
     ...
     <div className="relative">
       ...
       {showStudentSuggestions && studentInputValue.trim() && (
         <div className="absolute z-50 w-full mt-2 bg-white rounded-2xl shadow-2xl border-2 border-blue-100 max-h-[130px] overflow-y-auto">
           {studentAccounts
  ...
  <div className="mt-8 space-y-4 animate-in slide-in-from-top-4 relative">
     ...
     <div className="relative">
       ...
       {showTeacherSuggestions && teacherInputValue.trim() && (
         <div className="absolute z-50 w-full mt-2 bg-white rounded-2xl shadow-2xl border-2 border-rose-100 max-h-[130px] overflow-y-auto">
           {teachers
