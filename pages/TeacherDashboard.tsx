                ...
                <div className="bg-rose-50 rounded-[1.5rem] p-5 flex flex-col gap-4">
                  ...
                  <div className="border-t border-rose-200 pt-4 space-y-3">
                    ...
                    <div className="bg-white rounded-xl px-4 py-2">
                      <p className="text-[11px] font-black text-slate-800 uppercase tracking-wide leading-relaxed">{blockModal.className}</p>
                    </div>
                    <div className="bg-white rounded-xl px-4 py-3 space-y-1">
                      ...
                      <p className="text-[9px] font-bold text-rose-600">Sesi {blockModal.currentSession} / 6</p>
                    </div>
                  </div>
                </div>
