           ...
           <div className="text-center md:text-left flex-1">
              <div className="flex items-center justify-center md:justify-start gap-2">
                 ...
                 <p className="text-[11px] font-black text-emerald-700 uppercase tracking-widest leading-relaxed">
                    "Sertif & Rapot segera disimpan ya! Jika akun sudah tidak digunakan / tidak ada kelas aktif selama <span className="bg-rose-100 text-rose-600 px-2 py-0.5 rounded-lg">lebih dari 6 bulan</span>, akun akan dihapus pengurus demi kelancaran sistem."
                 </p>
              </div>
           </div>
        </div>
...
{isNextClass && (
  <div className="w-full py-5 bg-purple-600 text-white rounded-[2rem] font-black text-[10px] uppercase shadow-xl flex flex-col items-center justify-center gap-2">
    ...
    <p className="text-[10px] font-bold text-white/70 normal-case">Materi Level {course.level || 'BASIC'} belum selesai dipelajari 🌟</p>
  </div>
)}
                          </div>
                        )}
