      ...
      <div className="fixed left-[-9999px] top-0 pointer-events-none">
         ...
         {myPayments.map((p) => (
            <div id={`slip-digital-${p.id}`} ref={p.id === showDigitalSlip?.id ? slipRef : null} key={p.id} className="bg-white p-12 md:p-20 space-y-10 w-[700px] mx-auto overflow-hidden text-slate-900 border-8 border-double border-slate-100">
               ...
               <div className="pt-8 border-t-2 border-slate-900"><div className="flex justify-between items-start min-h-[32px]"><p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">VERIFIKASI SISTEM:</p><div className="text-right flex flex-col items-end"><p className="text-[9px] font-black text-slate-300 uppercase tracking-[0.2em] italic">Terverifikasi Digital</p><p className="text-[10px] font-black text-blue-600 uppercase tracking-widest mt-1">Status: LUNAS</p></div></div><p className="text-5xl font-black text-blue-600 italic leading-none mt-4 text-left">Rp {p.amount.toLocaleString()}</p></div>
