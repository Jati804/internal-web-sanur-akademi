...
const RoleCard = ({ icon: Icon, title, desc, color, onClick }: any) => {
  ...
  return (
    ...
    >
      <div className={`w-20 h-24 ${theme.bg} ${theme.text} rounded-[2rem] flex items-center justify-center mb-6 shadow-inner group-hover:rotate-6 group-hover:scale-110 transition-all duration-300`}>
        <Icon size={40} />
      </div>
