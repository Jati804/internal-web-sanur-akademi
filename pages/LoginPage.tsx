          ...
          {view === 'SELECTION' ? (
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
                <div className="fade-up-d2"><RoleCard icon={UserCog} title="Pengurus" color="blue" onClick={() => handleSelectRole('ADMIN')} /></div>
                <div className="fade-up-d3"><RoleCard icon={GraduationCap} title="Pengajar" color="orange" onClick={() => handleSelectRole('TEACHER')} /></div>
                <div className="fade-up-d4"><RoleCard icon={Users} title="Siswa" color="emerald" onClick={() => handleSelectRole('STUDENT')} /></div>
              </div>
